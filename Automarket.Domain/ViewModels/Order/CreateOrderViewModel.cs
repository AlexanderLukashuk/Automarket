...
namespace Automarket.Domain.ViewModels.Order
{
	public class CreateOrderViewModel
	{
		...
		[MaxLength(50, ErrorMessage = "The middle name must be less than 50 characters long")]
		[MinLength(2, ErrorMessage = "The middle name must be longer than 2 characters")]
